...
private:
			...
			case FETCH_INSTR:
				...
				case FETCH_TWO_BYTE_ADDRESS:
					...
					case SET_CONTROL_SIG_HI:
						...
						break;
					case READ_TO_ZR_HI:
						zr = (dataBus_in.read () << 8) | (zr & 0x00FF);
								...
								case 0x0E:
									...
									case 0x21:
										if (twoByteInstrB1 == 0xDD)
										{
											...
											case 6:  // Write hi byte to IX
												ix = (dataBus_in.read () << 8) | (ix & 0x00FF);
												std::cout << "Got hi byte " << dataBus_in.read () << std::endl;
												execCount++;
												break;
											case 7:
										...
										else
										{
											...
											case 6:  // Write hi byte to HL
												hl = (dataBus_in.read () << 8) | (hl & 0x00FF);
												std::cout << "Got hi byte " << dataBus_in.read () << std::endl;
												execCount++;
												break;
											case 7:
									...
									case 0x31:
										...
										case 2:
											...
											sp = (sp & 0xff00) | (0x00FF & dataBus_in.read ());
											std::cout << "Got low byte " << dataBus_in.read () << std::endl;
											execCount++;
											break;
										case 3:
										...
										case 6:  // Write hi byte to SP
											sp = (dataBus_in.read () << 8) | (sp & 0x00FF);
											std::cout << "Got hi byte " << dataBus_in.read () << std::endl;
											execCount++;
											break;
										case 7:
										...
										case 0x3A:	// MOV A, label
											...
											if(execCount == 0) std::cout << "EXECUTE  MOV A, label ... [START]" << std::endl;
										...
										case 0x32:	// MOV label, A
											if(execCount == 0) std::cout << "EXECUTE  MOV label, A ... [START]" << std::endl;
										...
										case 0x22:
											...
											{
												// MOV label,IX
												if(execCount == 0) std::cout << "EXECUTE  MOV label, IX ... [START]" << std::endl;
											...
											{
												// MOV label,HL
												if(execCount == 0) std::cout << "EXECUTE  MOV label, HL ... [START]" << std::endl;
										...
										case 0x2A:
											...
											{
												if(execCount == 0) std::cout << "EXECUTE  MOV IX, label ... [START]" << std::endl;
											...
											{
												if(execCount == 0) std::cout << "EXECUTE  MOV HL, label ... [START]" << std::endl;
	...
	traceIt ()
	{
     ...
     myWriter->traceWire8(dataBus_in.read().to_uint(), "DBus",
     sc_time_stamp().to_seconds());
...
*/
	...
	bool mov_label_register(sc_bv<8> *reg_source)
	{
		bool ready = false;
	...
	bool mov_register_label(sc_bv<8> *reg_destination)
	{
		bool ready = false;
		...
		case 10: //get data from Memory
			*reg_destination = dataBus_in.read();
			std::cout << "Got byte " << dataBus_in.read() << std::endl;
			execCount++;
			break;
		case 11: //  reset control signals
			resetProcSignals();
	...
	bool mov_register_label(sc_bv<16> *reg_destination)
	{
